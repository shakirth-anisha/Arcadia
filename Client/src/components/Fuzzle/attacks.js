...
const player_name = get_name_of_thingy("Ember");
const enemy_name = get_name_of_thingy("Dragon");
...
function attack({attacker, attackerHealth, attack, recipient, recipientHealth, isdone = false}) {
    ...
    switch (attack.name) {
        ...
        //         health_bar_animation(recipientHealth, attack.damage, recipient)
        //         hit_animation(recipient, recipientHealth, 0)
        //         console.log("1hp player and enemy");
        //     }
    ...
    if (newWidth === 0) {
        ...
        setTimeout(()=> {
            if (recipient.id !== "Ember"){
                ...
                document.getElementById("exp").innerHTML = parseInt(document.getElementById("exp").textContent) + 250;
                setTimeout(()=> {
                ...
                win_lose.style.transition = "opacity 500ms";
                win_lose.style.opacity = "0.9"; 
                if((parseInt(document.getElementById("exp").textContent) - 150)>=0)
                    document.getElementById("exp").innerHTML = parseInt(document.getElementById("exp").textContent) - 150; 
                else 
